...
export const prestamosConfig = {
    ...
    formulariosPDF: {
        'medico': '/assets/Formulario-Préstamo-medico.pdf',
        'emergencia': '/assets/Formulario-Préstamo-emergencia.pdf',
        'libre-disposicion': '/assets/Formulario-Prestamo-de-Libre-Disposición.pdf',
